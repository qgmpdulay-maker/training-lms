...
class ProfileUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
        {
            // Participant type, organization, agency, and email are locked on the
            // profile form (identity/administrative fields participants can't
            // self-edit — see update-profile-information-form.blade.php), so
            // they're never submitted and have no rules here.
            return [
