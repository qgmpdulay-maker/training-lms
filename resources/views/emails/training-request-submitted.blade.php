            ...
            <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
                ...
                <tr>
                    ...
                    <td style="padding: 8px 0; font-weight: 600;">
                        {{ $trainingRequest->requesting_agency }}
                        @if ($trainingRequest->agency_type)
                            ({{ \App\Models\TrainingRequest::$agencyTypeLabels[$trainingRequest->agency_type] ?? $trainingRequest->agency_type }})
                        @endif
                    </td>
                </tr>
                @if ($trainingRequest->lgu)
                    <tr>
                        <td style="padding: 8px 0; color: #6b7280;">LGU</td>
                        <td style="padding: 8px 0; font-weight: 600;">{{ $trainingRequest->lgu }}</td>
                    </tr>
                @endif
                <tr>
                    <td style="padding: 8px 0; color: #6b7280;">Region</td>
                    <td style="padding: 8px 0; font-weight: 600;">{{ $trainingRequest->region ?: '—' }}</td>
                </tr>
                <tr>
