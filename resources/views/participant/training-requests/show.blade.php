        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-8 sm:p-10">
                ...
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                    ...
                    @endif
                    @php $certificate = $trainingRequest->certificates->firstWhere('user_id', auth()->id()); @endphp
                    @if ($certificate)
                        <div class="sm:col-span-2">
                            ...
                            <dd class="text-sm">
                                ...
                                <span class="block text-xs text-gray-400 dark:text-gray-500 mt-1">{{ __('Certificate Code') }}: {{ $certificate->code }}</span>
                            </dd>
                        </div>
                    @endif
                </dl>
