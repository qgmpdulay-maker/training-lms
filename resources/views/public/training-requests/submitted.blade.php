        ...
        <div class="max-w-lg mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-8 sm:p-10 text-center">
                @if ($referenceNumber)
                    ...
                    <p class="text-2xl font-bold text-[#152A4E] tracking-wide mb-4">{{ $referenceNumber }}</p>

                    <p class="text-xs text-gray-400 mb-8">
                        {{ __('No account is needed to follow this up — just quote the reference number when OCD contacts you.') }}
                    </p>
